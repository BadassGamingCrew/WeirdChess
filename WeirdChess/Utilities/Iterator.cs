...
namespace WeirdChess.Utilities
{
    ...
    public class Iterator<T> : IIterator<T>
    {
        ...
        private void ValidateCollection(ICollection<T> col)
        {
            if (col.Equals(default(ICollection<T>)))
            {
                throw new IteratorOutOfRangeException("col", Messages.CollectionCannotBeNull);
            }
        }
